...
public interface Dao<T> {
	 ...
	 */
	List<T> queryForList(String sql, Object... args) throws Exception;
	 ...
	 */
	<V> V getSingleVal(String sql, Object... args) throws Exception;
	 ...
	 */
	void batch(String sql, Object[]... params) throws Exception;
}