...
public interface BookDAO  {
	 ...
	 * @return
	 */
	public abstract Book getBook(int id) throws Exception;
	 ...
	 * @return
	 */
	public abstract Page<Book> getPage(CriteriaBook cb) throws Exception;
	 ...
	 * @return
	 */
	public abstract long getTotalBookNumber(CriteriaBook cb) throws Exception;
	 ...
	 * @return
	 */
	public abstract List<Book> getPageList(CriteriaBook cb, int pageSize) throws Exception;
	 ...
	 * @return
	 */ 
	public abstract int getStoreNumber(Integer id) throws Exception;
